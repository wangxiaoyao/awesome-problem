## 1 如果你构建的网站或 Web 应用加载非常慢，你将如何处理？
...
```
1 排查/评估
- 浏览器开发者工具（DevTools）： Network 标签页，查看瀑布图（Waterfall），找出耗时最久的文件（HTML, CSS, JS, 图片, API 调用）。 前端后分开思考
...
## 2 如果你的团队中有两名开发者的代码提交冲突并导致构建失败，你会怎么处理？
